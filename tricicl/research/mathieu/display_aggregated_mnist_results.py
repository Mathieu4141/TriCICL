...
from tricicl.research.mathieu.aggregate_split_mnist_results import get_aggregate_csv_file
...
def display_aggregated_results(
    ...
    metrics_names = metrics_names or sorted(set(df["metric"]), key=get_metric_name_priority)
...
def get_metric_name_priority(name: str) -> Tuple[bool, str]:
